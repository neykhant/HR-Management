        ...
        <form action="{{ route('salary.update', $salary->id) }}" method="POST" id="edit-form">
            ...
            <div class="form-group">
                ...
                <select name="user_id" class="form-control select-ninja">
                    ...
                    <option value="{{ $employee->id }}" @if(old('user_id', $salary->user_id )==$employee->id ) selected @endif>{{ $employee->id }} ({{ $employee->name }}) </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="month" class="form-control select-month">
                    ...
                    <option value="09" @if($salary->month == '09') selected @endif >Set</option>
            ...
            <div class="form-group">
                ...
                <select name="year" class="form-control select-year">
                    ...
                    @for($i = 0 ; $i < 10; $i++) <option value="{{ now()->addYears(5)->subYears($i)->format('Y') }}" @if($salary->year == now()->addYears(5)->subYears($i)->format('Y') ) selected @endif>
...
{!! JsValidator::formRequest('App\Http\Requests\UpdateSalaryRequest', '#edit-form') !!}
